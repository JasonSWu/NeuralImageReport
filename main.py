...
def translate(model, src_sentence, tokenizer, preprocess_fn, output_tokens=False):
    model.eval()
...
if __name__ == "__main__":
    ...
    model = FineTuneTransformer(LLM, tokenizer, 5, 768, 8, 50257, embed_fn, 50000, dropout=0)
